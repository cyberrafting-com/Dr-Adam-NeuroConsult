        ...
        <div class="row">
            <div class="col-lg-12">
                <div class="top-bar-items">
                    ...
                    <a href="{{route('home')}}"><img src="{{ asset('/resources/assets/images/logo.png')}}" alt="logo" class="img-fluid"></a>
                    </div>
    ...
    <div class="container-lg container-fluid">    
        <div class="row">
            <div class="col-12 d-flex align-items-center justify-content-center">
                ...
                <div class="main-menu">
                    ...
                    <ul class="menu-list">
                        ...
                        <li class="menu-item-has-children">
                            <a href="#">Brain Surgery</a><i class="bx bx-plus dropdown-icon"></i>
                            <ul class="submenu">
                                <li><a href="{{route('brain-tumor-surgery-open-and-endoscopic')}}">Brain Tumor Surgery(Open & Endoscopic)</a></li>
                                <li><a href="{{route('minimal-invasive-surgery')}}">Minimal Invasive Surgery</a></li>
                                <li><a href="{{route('hydrocephalus')}}">Hydrocephalus</a></li>
                                <li><a href="{{route('vascular-disease-stroke-paralysis-avm-aneurysm')}}">Vascular Disease(Stroke/Paralysis, AVM, Aneurysm)</a></li>
                                <li><a href="{{route('epilepsy-surgery')}}">Epilepsy Surgery</a></li>
                                <li><a href="{{route('traumatic-brain-injury')}}">Traumatic Brain Injury(SDH, EDH, ICH)</a></li>
                            </ul>
                        </li>
                        <li class="menu-item-has-children">
                            <a href="#">Spine Surgery</a><i class="bx bx-plus dropdown-icon"></i>
                            <ul class="submenu">
                                <li><a href="{{route('disc-prolapse')}}">Disc Prolapse</a></li>
                                <li><a href="{{route('spinal-cord-tumor')}}">Spinal Cord Tumor</a></li>
                                <li><a href="{{route('spinal-trauma')}}">Spinal Trauma</a></li>
                                <li><a href="{{route('spondylosis')}}">Spondylosis</a></li>
                                <li><a href="{{route('nerve-repair')}}">Nerve Repair</a></li>
                                <li><a href="{{route('nerve-entrapment-surgery')}}">Nerve Entrapment Surgery</a></li>
                            </ul>
                        </li>
                        <li><a href="{{route('gallery')}}">Gallery</a></li>
                        <li class="menu-item-has-children">
                            <a href="#">Media</a><i class="bx bx-plus dropdown-icon"></i>
                            <ul class="submenu">
                ...
                <!--<div class="header-btn d-lg-block d-md-block d-none">-->
                <!--    <a class="btn--primary eg-btn" href="{{route('book-appointment')}}">Book Now</a>-->
                <!--</div>-->
